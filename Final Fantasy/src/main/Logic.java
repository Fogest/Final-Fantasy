...
public class Logic
{
  ...
  //will preform action then return what action happend to battle panel for graphics
  ...
  {
    if(bm.isAlive()==false&&n.isAlive()==false&&w.isAlive()==false&&d.isAlive()==false&&wm.isAlive()==false)
    {
      return true;
    }else
    {
  ...
  {
    if(enemy[0].isAlive()==false&&enemy[1].isAlive()==false&&enemy[2].isAlive()==false)
    {
      return true;
    }else
    {
