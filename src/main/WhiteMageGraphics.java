...
public class WhiteMageGraphics {
	private BufferedImage menu = ImageHelper
			.loadImage("images/whitemagemenu.jpg");
	private BufferedImage whitemageactions = ImageHelper
			.loadImage("images/whitemagesprites.png");
	private BufferedImage whitemageactions2 = ImageHelper.makeColorTransparent(
			whitemageactions, new Color(255, 0, 255));
	private BufferedImage[] wma = ImageHelper.splitImage(whitemageactions2, 12,
			1);
