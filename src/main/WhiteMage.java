...
public class WhiteMage extends Character {
	...
	/**
	 * method is used to buff allies, using magic type variable to determine
	 * buff type
	 * 
	 * @param bm
	 * used when player selects black mage to buff
	 * @param wm
	 * used when player selects white mage to buff
	 * @param d
	 * used when player selects dragoon to buff
	 * @param n
	 * used when player selects ninja to buff
	 * @param w
	 * used when player selects warrior to buff
	 * @param t
	 * used to determine who is being buffed
	 */
	public void magicAttack(BlackMage bm, WhiteMage wm, Dragoon d, Ninja n,
			Character w, String t) {
